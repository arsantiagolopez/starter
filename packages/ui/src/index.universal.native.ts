// Universal exports - native platform
export { View, type ViewProps } from './primitives/view/index.native'
export { Text, type TextProps } from './primitives/text/index.native'
export { Pressable, type PressableProps } from './primitives/pressable/index.native'
